...
<div class="py-60">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="pe-lg-40">
                    <h4 class="py-10 m-0" data-show="startbox">Name Change Procedure In Bangalore
                    </h4>
                    <p data-show="startbox" data-show-delay="100">Welcome to Name Change Services Bangalore. We have a team of Legal Consultant, An Advocate, and a subject matter expert who help the client in changing their name by depth understanding of the concerns advising them best solution in regard to Name change/ Name correction.</p>
                    <h5 class="py-10 m-0" data-show="startbox">Need Help Changing Your Name in Bengaluru? </h5>
                    <p data-show="startbox" data-show-delay="100">We offer easy-to-understand name change help in Bangalore. Our team is made up of legal experts who know a lot about helping people change their names legally. They have helped many people over the years and can make the process easy, from filling out your first form to getting your new name published in the official Gazette.</p>
                    <p class="m-0 p-0" data-show="startbox" data-show-delay="100">We do more than just help you with difficult government rules. We make everything clear and easy for you. We get how hard paperwork can be and we're here to make it much simpler. For the last ten years, people of Bangalore have counted on us to help them start using their new names without any trouble.</p>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="position-relative shape-parent">
                    ...
                    <div class="" data-img-height style="--img-height: 70%;" data-show="startbox"><a class="image-link" href="assets/img/about-us-3-900x630.jpg"><img class="rounded-4" loading="lazy" src="assets/img/about_us.avif" alt=""></a></div>
                </div>
            </div>
        </div>
    </div>
...
<div class="py-50">
    <div class="container">
        <h3 class="text-center mb-20" data-show="startbox" data-show-delay="100">Documents Required For <span class="highlight"> Name Change </span> in Bangalore </h3>
        <div class="row gy-10">
            <div class="col-12 col-md-6 col-lg-4" data-show="startbox">
                <ul class="list fw-medium font-size-15">
                    <li class="active">The first thing that you should have proof of residence of bangalore or India like Voter, Electricity Bill.</li>
                </ul>
            </div>

            <div class="col-12 col-md-6 col-lg-4" data-show="startbox" data-show-delay="100">
                <ul class="list fw-medium font-size-15">
                    <li class="active">Second thing that you should have proof of identity and the following documents can be used for verification: AADHAR card, PAN card, driving license, etc.</li>
                </ul>
            </div>
            <div class="col-12 col-md-6 col-lg-4" data-show="startbox" data-show-delay="200">
                <ul class="list fw-medium font-size-15">
                    <li class="active"><strong>Gazette notification</strong> :- You have to provide to concern department when you are changing name in any document.</li>
                </ul>
            </div>
            <div class="col-12 col-md-6 col-lg-4" data-show="startbox" data-show-delay="200">
                <ul class="list fw-medium font-size-15">
                    <li class="active">If the applicant is married, any documents which have husdand name with your name will be needed.</li>
                </ul>
            </div>
            <div class="col-12 col-md-6 col-lg-4" data-show="startbox" data-show-delay="300">
                <ul class="list fw-medium font-size-15">
                    <li class="active">If the applicant is divorced then divorce degree documents will be needed.</li>
                </ul>
            </div>
            <div class="col-12 col-md-6 col-lg-4" data-show="startbox">
                <ul class="list fw-medium font-size-15">
                    <li class="active">A photocopy of the affidavit.</li>
                </ul>
            </div>
            <div class="col-12 col-md-6 col-lg-4" data-show="startbox" data-show-delay="100">
                <ul class="list fw-medium font-size-15">
                    <li class="active">A newspaper advertisment will be needed coantain old and new name.</li>
                </ul>
            </div>
            <div class="col-12 col-md-6 col-lg-4" data-show="startbox" data-show-delay="100">
                <ul class="list fw-medium font-size-15">
                    <li class="active">A passport-size photo is also needed.</li>
                </ul>
            </div>
            <div class="col-12 col-md-6 col-lg-4" data-show="startbox" data-show-delay="300">
                <ul class="list fw-medium font-size-15">
